...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-08-2024 a las 18:42:28
...
--
-- Base de datos: `aguilas_foraneas`
--
...
ALTER TABLE `usuarios`
  ...
  ADD KEY `usuarios_carreras_FK` (`id_carrera`);
...
ALTER TABLE `comentarios`
  ...
  ADD CONSTRAINT `comentarios_ibfk_2` FOREIGN KEY (`id_lugar`) REFERENCES `lugares` (`id_lugar`);
...
--
ALTER TABLE `usuarios`
  ADD CONSTRAINT `usuarios_carreras_FK` FOREIGN KEY (`id_carrera`) REFERENCES `carreras` (`id_carrera`);
COMMIT;
